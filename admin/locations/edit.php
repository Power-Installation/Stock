                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
    	        			<button type="submit" class="btn btn-success btn-sm">Edit Location</button>
                        </div>
                    </div>
                </div>
            </form>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {	
        $newlocname = $conn->real_escape_string($_POST['name']);
        ...
        $updateloc = "UPDATE locations SET locname = '$newlocname', street = '$newstreet', number = '$newnumber', bus = '$newbus', zipcode = '$newzipcode', city = '$newcity', country = '$newcountry' WHERE idlocations = '$id'";

        if ($conn->query($updateloc) === true) {
            $_SESSION['message'] = "$locname has been modified.";
            header("location: ./index.php");
        }
        else {
            $_SESSION['message'] = "$locname could not be modified";
        }
        mysqli_close($conn);
    };
?>
