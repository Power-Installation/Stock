                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" autocomplete="off" name="brandname" placeholder="Brand Name" class="form-control" required/>
                            </div>
                        </div>
        				<div class="form-group">
                            <label for="website" class="control-label">Website url</label>
                            <div>
                                <input type="text" autocomplete="off" name="website" placeholder="Website url" class="form-control" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="file" class="control-label">Logo</label>
                            <div>
                                <input type="file" autocomplete="off" name="file" class="form-control"/>
                            </div>
                        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if(empty($_POST['file'])) {
		...
		$altaddbrand = "INSERT INTO brands (brandname, website, logo) values('$brand', '$website', '$name')";
		
		if ($conn->query($altaddbrand) === true) {
		...
		$brand1 = $conn->real_escape_string($_POST['brandname']);
